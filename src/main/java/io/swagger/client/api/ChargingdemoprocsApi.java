...
public class ChargingdemoprocsApi  extends ChargingdemoprocsApiClassic {
    ...
    public io.swagger.client.model.UserObject getAndLockUser(java.lang.Long body) throws ApiException {
        
        info("getAndLockUser: " + body);
        // Return object
        io.swagger.client.model.UserObject objectToReturn = null;

        // Type for return object
        final Type userObject_type = new TypeToken<io.swagger.client.model.UserObject>(){}.getType();
        ...
        try {
            ...
            if (sad.statusCode >= RESPONSE_GOOD_START && sad.statusCode  <= RESPONSE_GOOD_END) {
                objectToReturn = (io.swagger.client.model.UserObject) sad.returnObject;
    ...
    @SuppressWarnings("unchecked")
    public io.swagger.client.model.ReportQuotaUsageStatus reportQuotaUsage(java.lang.Long userId, java.lang.Integer unitsUsed, java.lang.Integer unitsWanted, java.lang.Long inputSessionId, java.lang.String txnId) throws ApiException {
        
        info("reportQuotaUsage: " + userId + " " + unitsUsed + " " + unitsWanted + " " + inputSessionId + " " + txnId);
        // Return object
        io.swagger.client.model.ReportQuotaUsageStatus objectToReturn = null;

        // Type for return object
        final Type reportQuotaUsageStatus_type = new TypeToken<io.swagger.client.model.ReportQuotaUsageStatus>(){}.getType();
        ...
        try {
            ...
            if (sad.statusCode >= RESPONSE_GOOD_START && sad.statusCode  <= RESPONSE_GOOD_END) {
                objectToReturn = (io.swagger.client.model.ReportQuotaUsageStatus) sad.returnObject;
                return objectToReturn;
            }
    ...
    @SuppressWarnings("unchecked")
    public java.lang.String updateLockedUser(java.lang.Long userId, java.lang.Long sessionId, java.lang.String jsonPayload, java.lang.String deltaOperationName) throws ApiException {
    ...
    @SuppressWarnings("unchecked")
    public io.swagger.client.model.AddCreditUserStatus addCredit(java.lang.Long userId, java.lang.Long extraCredit, java.lang.String txnId) throws ApiException {
        
        info("addCredit: " + userId + " " + extraCredit + " " + txnId);
        // Return object
        io.swagger.client.model.AddCreditUserStatus objectToReturn = null;

        // Type for return object
        final Type addCreditUserStatus_type = new TypeToken<io.swagger.client.model.AddCreditUserStatus>(){}.getType();
        ...
        try {
            ...
            if (sad.statusCode >= RESPONSE_GOOD_START && sad.statusCode  <= RESPONSE_GOOD_END) {
                objectToReturn = (io.swagger.client.model.AddCreditUserStatus) sad.returnObject;
                return objectToReturn;
            }
    ...
    @SuppressWarnings("unchecked")
    public java.lang.String delUser(java.lang.Long userId) throws ApiException {
    ...
    @SuppressWarnings("unchecked")
    public io.swagger.client.model.UserObject getUser(java.lang.Long userId) throws ApiException {
    ...
    @SuppressWarnings("unchecked")
    public java.lang.String upsertUser(java.lang.Long body) throws ApiException {
